'''
16.	Evaluate the following expressions. First, try to do it without using a computer. Then, check the results on your computer (run Python in interactive mode). 
